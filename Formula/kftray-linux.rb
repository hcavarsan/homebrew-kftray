class KftrayLinux < Formula
    ...
    if variant[:os] == :newer_glibc && variant[:arch] == :amd64
        url "https://github.com/hcavarsan/kftray/releases/download/v0.25.1/kftray_0.25.1_newer-glibc_amd64.AppImage"
        sha256 "5d081b153ade66583905cfa8080f1f34bcd053db45a4fc501b75a6a37fa39daf"
    elsif variant[:os] == :newer_glibc && variant[:arch] == :arm64
        url "https://github.com/hcavarsan/kftray/releases/download/v0.25.1/kftray_0.25.1_newer-glibc_aarch64.AppImage"
